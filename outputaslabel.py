...
class myGUI:
    ...
    def __init__(self):
        ...
        self.miles = tkinter.Label(self.midframe,textvariable=self.miles_var)
            #Not hard coding the text, rather uses a variable 'self.miles_var'
    ...
    def convert(self):
        ...
        self.miles_var.set(miles)
            #The set method allows us to put information into a variable we have created, in this instance 'miles_var'
